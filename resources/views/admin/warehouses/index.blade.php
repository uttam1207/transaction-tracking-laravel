...
<div class="page-hero">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative;z-index:1;">
        ...
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-primary-grad btn-sm px-4" data-bs-toggle="modal" data-bs-target="#addWarehouseModal">
...
<div class="card-glass mb-3 px-4 py-3">
    <form method="GET" class="row g-2 align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('admin.warehouses.index') }}" class="btn btn-outline-secondary btn-sm">Clear</a>
        </div>
    </form>
</div>
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <button class="act-btn"
                            onclick="editWarehouse({{ $wh->id }}, @json($wh))"><i class="bi bi-pencil"></i></button>
                    </div>
                    <h6 class="fw-bold mb-1">{{ $wh->name }}</h6>
                    <div class="text-muted small mb-2">
                        @if ($wh->city)
                            {{ $wh->city }}@if ($wh->country), {{ $wh->country }}@endif
                        @endif
                    </div>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.warehouses.show', $wh) }}"
                            class="btn btn-outline-primary btn-sm w-100">View Stock</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">New Warehouse</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
<div class="modal fade" id="editWarehouseModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Warehouse</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body row g-3">
                <div class="col-md-4"><label class="form-label">Code</label><input type="text" id="e_code" class="form-control"></div>
                <div class="col-md-8"><label class="form-label">Name</label><input type="text" id="e_name" class="form-control"></div>
                <div class="col-md-6"><label class="form-label">City</label><input type="text" id="e_city" class="form-control"></div>
                <div class="col-md-6"><label class="form-label">Country</label><input type="text" id="e_country" class="form-control"></div>
                <div class="col-md-6">
                    <label class="form-label">Manager</label>
