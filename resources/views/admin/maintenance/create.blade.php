            ...
            <div style="background:linear-gradient(135deg,#dc2626,#b91c1c);padding:22px 28px;position:relative;overflow:hidden;">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div style="font-size:1.1rem;font-weight:800;color:#fff;letter-spacing:-.01em;">Maintenance Record</div>
                        <div style="color:rgba(255,255,255,.7);font-size:.8rem;margin-top:2px;">Service, breakdown and preventive schedule</div>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.maintenance.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-2">
                        ...
                        <button type="submit" class="btn btn-primary-grad px-5">
                            <i class="bi bi-check-lg me-1"></i>Save Maintenance Log
                        </button>
                    </div>
                </form>
            </div>
