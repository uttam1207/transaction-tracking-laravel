    ...
    <div class="p-4">
        ...
        <form action="{{ route('admin.sales.update', $salesOrder) }}" method="POST" id="saleForm">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3 {{ in_array($editStatus, ['Paid','Partial','UnbilledPaid','UnbilledPartial']) ? '' : 'd-none' }}" id="paymentModeRow">
                ...
                <div class="col-md-3 {{ in_array($editStatus, ['Partial','UnbilledPartial']) ? '' : 'd-none' }}" id="amountPaidRow">
