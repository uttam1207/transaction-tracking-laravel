...
<div class="page-hero">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative;z-index:1;">
        <div>
            ...
            <p>Record a new expense entry for AS Dairy</p>
        </div>
        ...
        <div class="card-glass p-4">
            <form method="POST" action="{{ route('admin.expenses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                                placeholder="e.g. Green fodder purchase from Ramu farm" value="{{ old('description') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="vendor_payee" class="form-control @error('vendor_payee') is-invalid @enderror"
                                placeholder="Person or company paid" value="{{ old('vendor_payee') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="reference_number" class="form-control @error('reference_number') is-invalid @enderror"
                                placeholder="Txn ID / Cheque No." value="{{ old('reference_number') }}">
                ...
                <div class="d-flex justify-content-end gap-2 pt-2">
                    <a href="{{ route('admin.expenses.index') }}" class="btn btn-outline-secondary px-4">Cancel</a>
                    <button type="submit" class="btn btn-primary-grad px-5"><i class="bi bi-check-lg me-1"></i>Save Expense</button>
                </div>
            </form>
        </div>
    </div>
