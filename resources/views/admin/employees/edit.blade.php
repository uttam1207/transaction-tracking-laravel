...
<div class="page-hero">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative;z-index:1;">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.employees.show', $employee) }}" class="btn btn-sm" style="background:rgba(255,255,255,.15);color:#fff;border:1.5px solid rgba(255,255,255,.3);border-radius:9px;font-weight:600;backdrop-filter:blur(4px);">
                <i class="bi bi-eye me-1"></i>View
            </a>
            <a href="{{ route('admin.employees.index') }}" class="btn btn-sm" style="background:rgba(255,255,255,.15);color:#fff;border:1.5px solid rgba(255,255,255,.3);border-radius:9px;font-weight:600;backdrop-filter:blur(4px);">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-glass overflow-hidden mb-4">
            <div style="background:linear-gradient(135deg,#2563eb,#4f46e5);padding:16px 24px;position:relative;overflow:hidden;">
                ...
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-person-fill" style="color:rgba(255,255,255,.85);font-size:1rem;"></i>
                    <span style="font-size:.9rem;font-weight:700;color:#fff;">A — Personal Information</span>
                </div>
            </div>
            <div class="p-4">
                <div class="row g-3">
        ...
        <div class="card-glass overflow-hidden">
            <div style="background:linear-gradient(135deg,#0891b2,#2563eb);padding:16px 24px;position:relative;overflow:hidden;">
                <div style="position:absolute;top:-20px;right:-20px;width:100px;height:100px;background:rgba(255,255,255,.07);border-radius:50%;pointer-events:none;"></div>
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-briefcase-fill" style="color:rgba(255,255,255,.85);font-size:1rem;"></i>
                    <span style="font-size:.9rem;font-weight:700;color:#fff;">B — Employment Details</span>
                </div>
            </div>
            <div class="p-4">
                <div class="row g-3">
    ...
    <div class="col-lg-4">
        ...
        {{-- Profile Photo --}}
        <div class="card-glass overflow-hidden mb-4">
            <div style="background:linear-gradient(135deg,#7c3aed,#5b21b6);padding:16px 24px;position:relative;overflow:hidden;">
                <div style="position:absolute;top:-20px;right:-20px;width:100px;height:100px;background:rgba(255,255,255,.07);border-radius:50%;pointer-events:none;"></div>
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-camera-fill" style="color:rgba(255,255,255,.85);font-size:1rem;"></i>
                    <span style="font-size:.9rem;font-weight:700;color:#fff;">Profile Photo</span>
                </div>
            </div>
        ...
        <div class="card-glass overflow-hidden mb-4">
            <div style="background:linear-gradient(135deg,#374151,#1f2937);padding:16px 24px;position:relative;overflow:hidden;">
                <div style="position:absolute;top:-20px;right:-20px;width:100px;height:100px;background:rgba(255,255,255,.07);border-radius:50%;pointer-events:none;"></div>
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-shield-lock-fill" style="color:rgba(255,255,255,.85);font-size:1rem;"></i>
                    <span style="font-size:.9rem;font-weight:700;color:#fff;">Security</span>
                </div>
            </div>
            <div class="p-4">
