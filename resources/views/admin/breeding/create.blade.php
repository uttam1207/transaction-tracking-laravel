...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card-glass p-4">
            ...
            <form action="{{ route('admin.breeding.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold">
                            <i class="bi bi-paperclip me-1"></i>Attach Certificate / AI Receipt
                        </label>
                        <input type="file" name="certificate_file" id="breedingCertFile"
                            class="form-control @error('certificate_file') is-invalid @enderror"
                            accept=".pdf,.jpg,.jpeg,.png"
                            onchange="showFileName(this,'breedingFileHint')">
                        <div id="breedingFileHint" class="form-text text-muted" style="font-size:.75rem;">
