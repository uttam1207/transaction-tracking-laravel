...
class ServicePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $services = [
            ...
            ['sort_order' => 30,  'service_key' => 'animals',            'service_name' => 'Animals',               'icon' => 'egg-fried',          'description' => 'Manage livestock and animal records',             'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 31,  'service_key' => 'breeds',             'service_name' => 'Breeds',                'icon' => 'diagram-3',          'description' => 'Manage animal breed definitions',                 'allowed_roles' => ['admin', 'manager']],
            ['sort_order' => 32,  'service_key' => 'milk',               'service_name' => 'Milk Production',       'icon' => 'droplet-half',       'description' => 'Record and track daily milk production',          'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 33,  'service_key' => 'breeding',           'service_name' => 'Breeding',              'icon' => 'heart-pulse',        'description' => 'Manage animal breeding records',                  'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 34,  'service_key' => 'health',             'service_name' => 'Animal Health',         'icon' => 'capsule',            'description' => 'Track health records and vet visits',             'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 35,  'service_key' => 'feed',               'service_name' => 'Feed Calculator',       'icon' => 'basket',             'description' => 'Calculate and track animal feed',                 'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 36,  'service_key' => 'farm',               'service_name' => 'Farm Management',       'icon' => 'house-door',         'description' => 'Manage farm facilities and infrastructure',        'allowed_roles' => ['admin', 'manager']],

            // ── Inventory / Operations ────────────────────────────────────
            ['sort_order' => 40,  'service_key' => 'stock',              'service_name' => 'Inventory & Stock',     'icon' => 'boxes',              'description' => 'Manage inventory items and stock levels',         'allowed_roles' => ['admin', 'manager']],
            ['sort_order' => 41,  'service_key' => 'maintenance',        'service_name' => 'Maintenance',           'icon' => 'wrench',             'description' => 'Log and manage equipment maintenance',            'allowed_roles' => ['admin', 'manager', 'employee']],
            ['sort_order' => 42,  'service_key' => 'compliance',         'service_name' => 'Compliance',            'icon' => 'patch-check',        'description' => 'Manage compliance records and documents',         'allowed_roles' => ['admin', 'auditor']],
